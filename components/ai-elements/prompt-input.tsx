...
// Derived from the components' own prop types rather than hand-written DOM
...
// base-ui's HoverCard root does not accept openDelay/closeDelay; the component
// shipped passing them through anyway. Forwarding props unchanged.
