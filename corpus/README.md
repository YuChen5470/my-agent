...
| --- | --- | --- |
| `ALevelSpec.pdf` | Edexcel A level Mathematics specification (9MA0) | [Pearson qualifications](https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/mathematics-2017.html) — "Specification" under Course materials |
